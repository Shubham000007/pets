...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/dist/js/bootstrap-select.js">
<script src="<?php echo base_url(); ?>assets/admin/dist/js/script.js?v2"></script>
</body>
