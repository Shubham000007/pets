...
<section class="booking__banner__section">
    <div class="booking__container my__container">
        <h4>Make your booking for boarding pets in Onkaparinga Hills</h4>
    </div>
</section>
<!-- Booking Banner section Ends -->

<!-- Booking Intro section -->

<section class="booking__intro__section">
    <div class="booking__intro__container my__container">
        <p>
            If you've just booked your next getaway, don't forget about your pets.
            Book them into the Dogs and Mogs Holiday Centre. To secure your pet's
            spot at the boarding kennels and catteries, fill out the booking
            request below or give us a call on 08 8325 0666. Once we have received
            your booking request, we will contact you to confirm your booking. So
            what are you waiting for? Book your boarding pets holiday at Dogs and
            Mogs Holiday Centre now!
        </p>

        <p class="text-bold">
            For booking enquiry via <span class="text-primary">email</span> please
            provide:
        </p>
        <p>* Yours and Pets Name</p>
        <p>* Contact details</p>
        <p>* Breed and Pets DOB</p>
        <p>* Dates required</p>
        <p>* Vaccination</p>
        <p>* Any other additional information</p>
    </div>
</section>
<!-- Booking Intro section Ends -->

<!-- Booking form  -->

<section class="booking__form__section">
        ...
        <div class="booking__form">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <label for="">How many animals are you booking for?</label>
                        <input type="text" name="animal_looking_for" id="animal_looking_for" class="form-control">
                        <p>PLEASE NOTE we are CLOSED during certain dates during peak times.</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="animal_name" class="form-control" name="animal_name">
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <p>Dogs must have a full C5 vaccine and Cats a minimum of F3. Vaccines must be up to date for their entirety of the animals receiving boosters before visiting must have a two grace period before boarding. Animals who are not vaccinated within our guidelines will be refused entry.
                    </p>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="date" name="animal_dob" id="animal_dob" class="form-control">
                </div>
                ...
                <div class="col-sm-12">
                    <label for="">Current vet clinic</label>
                    <input type="text" class="form-control" name="current_clinic" id="current_clinic">
                </div>

                <div class="col-sm-12">
                    <label for="">Any medications required?</label>
                    <input type="text" class="form-control" name="medication_required" id="medication_required">
                </div>

                <div class="col-sm-12">
                    <label for="">Are there any behaviour issues we need to be made aware of?</label>
                    <input type="text" class="form-control" name="behaviourial_issue" id="behaviourial_issue">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <p>If boarding more than one animal of the same species, do you give permission for them to share accommodation and play time? Dogs who are no desexed cannot share accommodation no matter their sex. Windamere reserves the right to separate at any point should they deem it necessary. If your dog sufferes form aggression, anxiety, resource guarding, canine reactivity or other related behavioural issues it is advised to book separate accommodation. Windamere will do everything they can to keep your animals as close as possible during their stay.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
...
<section class="location__with__contact__section">
    <div class="location__with__contact__container my__container">
        ...
        <div class="location__contact__details">
            ...
            <p>54 Kellys Rd Onkaparinga Hills South</p>
            <p>5163 Australia</p>
